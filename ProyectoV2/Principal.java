...
public class Principal {
	...
	public static void main(String[] args) {
		...
		lp1.adiFinal(new Paciente("000012", "saul aguilar", 19, 3123313));
		lp1.adiFinal(new Paciente("000015", "carlos mendez", 29, 48275843));
		lp1.adiFinal(new Paciente("000018", "victor ramirez", 39, 93857432));
		lp1.adiFinal(new Paciente("000011", "juan basquez", 21, 329485761));
		lp1.adiFinal(new Paciente("000019", "pedro conde", 22, 32019485));
		lp1.adiFinal(new Paciente("000025", "alex marin", 18, 31827569));
		...
		System.out.println("\n2 De los pacientes con sintomasX modificar el tratamiento a “Fisioterapia”");
		
		String SintomaX = "dolor de muñeca";
		modificarTratamiento(c.getLh(), SintomaX);
		
		
		System.out.println("\n3 Mostrar el nombre y especialidad de los doctores que antendieron al paciente con CiX");
		int ciX = 48275843;
		mostrarDoctorPacienteX(c.getPm(),c.getLp(),c.getLh() ,ciX);
		
		System.out.println("\n4 El paciente con idX que esta en la cola de espera del consultorio con idY \r"
				+ "tiene que ser atendido de emergencia, llevarlo al principio de la cola de espera");
	...
	private static void mostrarDoctorPacienteX(PilaM pm, LD_NormalP lp, LD_NormalH lh, int ciX) {
		NodoP R = lp.getP();
